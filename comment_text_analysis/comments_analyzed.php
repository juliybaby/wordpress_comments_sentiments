...
$wp_plugin_url= strip_tags($_POST['wp_plugin_url']);
...
echo "<div style='color:white;background:green;padding:10px;'>Comments Successfully Analyzed. See Below</div>";
...
echo 
  "<div style='background:#c1c1c1;color:black;'><b style='color:#800000'>Comments Sentimental Analysis</b>
 ...
 <div class='title_css1'><b style='color:#800000;font-size:16px;'>Analyzed Comments Sentimental Tags: &nbsp;
</b> $sentiments&nbsp;&nbsp;&nbsp;
<b style='color:#800000;font-size:16px;'>Confidence:</b> $confidence %</div>

<div>
The Customer/User is <b> $confidence1 &nbsp;&nbsp;</b><img src='$wp_plugin_url/emotion_img/$emotion_img'style='width:60px;max-width:60px;height:60px;max-height:60px;border-style: solid; border-width:3px; border-color: orange;border-radius:50%'>
</div>
...
$plugin_url_tb = $wp_plugin_url;
$chart_file ='Chart.min.js';
$comments_file2 ='comments_statictics.php';

$url_comments_file2= $plugin_url_tb.$comments_file2;
$url_chart_file= $plugin_url_tb.$chart_file;
...
<br><br><h3 style='width:100%;min-width:100%;'>Comments Statistical Text Analytics</h3>
...
<script type="text/javascript" src="<?php echo $url_chart_file; ?>"></script>
...
var overall = '<?php echo $overall ?>';
                ...
                $.post('<?php echo $url_comments_file2; ?>?negativity='+negativity + "&positivity=" + positivity + "&overall=" + overall,
                function (data)
                {
                    console.log(data);
                     var name = [];
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'Comments Sentimental Text Analysis',
